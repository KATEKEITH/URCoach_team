...
class ExerciseList extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`http://54.180.81.203/exercises/findByChallengeId/${challengeId}`)
      .then(res => {
  ...
  exercised = (exerciseId, myExerciseSet, myExerciseCount) => (e) => {
    ...
    axios
      .post(`http://54.180.81.203/MyExercise/insert2/${memberId}/${exerciseId}`,JSON.stringify(data),{headers: headers})
      .then(res => {
        alert("도전 완료 성공")
      })
      .catch(e => {
