...
class CoachInsertForm extends Component {
    ...
    handleChange = (e) => {
     ...
     insertGym = (e) => {
        ...
        axios.post(`http://54.180.81.203/gyms/insert`, JSON.stringify(data), { headers: headers })
            .then( res => {
            alert("Gym 입력 성공")
            //coach input
            ...
            axios.post(`http://54.180.81.203/coaches/insert/${memberId}/${gymId}`, JSON.stringify(data), { headers: headers })
                .then(res => {
                    alert("코치 입력성공")
