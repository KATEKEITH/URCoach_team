...
class CoachMatchingDetail extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`http://54.180.81.203/coaches/findbycoachid/${coachId}`)
            .then(res => res.json())
        ...
        fetch(`http://54.180.81.203/gyms/find/${gymId}`)
            .then(res => res.json()
            ).then(res => {
                this.setState({
                    gym: res
    ...
    createUser() {
        fetch(`http://54.180.81.203/coaches/find/${this.state.coach.coachName}`)
            .then(res => res.json()
            ).then(res => {
                this.setState({
                    coach: res
