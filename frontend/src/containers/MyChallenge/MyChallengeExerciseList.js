...
class MyChallengeExerciseList extends Component {
  ...
  componentDidMount() {
    ...
    axios
        .get(`http://54.180.81.203/MyExercise/findbymychallengeid/${myChallengeId}`)
        .then(res => {
  ...
  myExercised = (myExerciseId, myExerciseSet, myExerciseCount) => (e) => {
    ...
    axios
      .put(`http://54.180.81.203/MyExercise/update2/${myExerciseId}`,JSON.stringify(data),{headers: headers})
      .then(res => {
        alert('운동 완료')
      })
  }
