...
class MyChallengeExercise extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`http://54.180.81.203/exercises/findGroupByExerciseName`)
      .then(res => {
  ...
  handleSubmit = (exerciseId, memberId, myChallengeId) => (e) => {
    ...
    axios
      .post(`http://54.180.81.203/MyExercise/insert/${memberId}/${exerciseId}/${myChallengeId}`, JSON.stringify(data), {headers: headers})
      .then(res => {
        alert('저장 성공')
      })
